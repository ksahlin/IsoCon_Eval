...
do
    ...
    echo python get_distinct_isoforms.py $sam_folder/53_isoforms_blat_w_header.sam $sam_folder/$sample\_blat_w_header.sam $output $sample
...
python plot_hits.py $output/all_samples.tsv $transcript_folder/53_isoforms/final_candidates.fa ~/tmp/heatmap_test_53.pdf
